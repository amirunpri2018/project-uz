...
<header class="navbar navbar-expand-lg navbar-light bg-light" style="
ul {
     list-style: none;
     float: left;
}
...
<li class="list-group-item">
    ...
    <i class="fas fa-align-justify"></i> Wszystkie produkty</a></li>
                ...
                <li class="nav-item hidden" style="margin-top: 9px; margin-left: 8px; opacity: 1;">
                    ...
                    if ($result = $polaczenie->query("SELECT * FROM article WHERE category_id=2 ORDER BY price DESC")) {
        ...
        <div id="lista_produktow">
            ...
            $sql = "SELECT * FROM article WHERE category_id=2 ORDER BY price DESC";
